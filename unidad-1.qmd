...
$$
A continuación, se muestra la simulación de un movimiento rectilineo uniforme. Esto es, una particula moviéndose en una dimensión con velocidad constante.
